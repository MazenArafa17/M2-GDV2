...
public class Shoot : MonoBehaviour
{
    ...
    [SerializeField] private float forceBuild = 45f;
    ...
    private void HandleShot()
    {
        ...
        if (Input.GetMouseButtonDown(0))
        {
            ...
            _lineActive = true; //zet de lijn aan
        }
        ...
        if (Input.GetMouseButtonUp(0))
        {
            ...
            _lineActive = false; //zet de lijn uit
            _line.SetPosition(1, Vector3.zero); //zet het eindpunt van de lijn weer op 0,0,0 zodat hij onzichtbaar word
